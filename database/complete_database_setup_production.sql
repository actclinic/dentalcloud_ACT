-- ============================================================================
-- DENTAL CLOUD - PRODUCTION DATABASE INITIALIZATION SCRIPT
-- ============================================================================
-- This script is the production-oriented variant of complete_database_setup.sql.
-- Run this in your Supabase SQL Editor to set up a fresh database from scratch.
--
-- Differences from the non-production setup file:
-- - Keeps the current permissive RLS model unchanged
-- - Keeps the default admin bootstrap account
-- - Does NOT insert demo/sample patients, doctors, medicines, treatments,
--   loyalty rules, or a default staff account
-- 
...
-- No demo/sample operational data is inserted in the production setup file.
