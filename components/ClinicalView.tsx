            ...
            <table className="w-full min-w-[42rem] text-left text-[15px]">
              ...
              <tbody className="divide-y divide-gray-50">
                {medicineHistoryLoading ? (
                  <tr>
                    <td colSpan={6} className="px-5 py-12 text-center md:px-7" role="status" aria-live="polite">
            ...
            <table className="w-full min-w-[58rem] text-left text-[15px]">
              ...
              <tbody className="divide-y divide-violet-50">
                {paymentHistoryLoading ? (
                  <tr>
                    <td colSpan={8} className="px-5 py-12 text-center md:px-7" role="status" aria-live="polite">
                      <Loader2 className="mx-auto mb-3 animate-spin text-violet-500" size={30} aria-hidden="true" />
