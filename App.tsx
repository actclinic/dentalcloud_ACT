...
const App: React.FC = () => {
  ...
  const handleSendRecallEmail = async (
    ...
    try {
      ...
      const emailHtml = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 30px; text-align: center;">
            <h1 style="color: white; margin: 0; font-size: 28px;">ðŸ¦· Dental Recall Notice</h1>
          </div>
          ...
          <div style="padding: 30px; background: #f9fafb;">
            ...
            <div style="background: white; border-left: 4px solid #667eea; padding: 20px; margin: 20px 0; border-radius: 8px;">
              <h2 style="color: #1f2937; margin: 0 0 15px 0; font-size: 20px;">ðŸ“‹ Recall Details</h2>
      ...
      await api.email.sendManagerEmail({
        to: patientEmail,
        subject: `ðŸ¦· Dental Recall Reminder: ${recallTitle}`,
        html: emailHtml,
